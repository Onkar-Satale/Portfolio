...
export default function FeaturedProjectsSection() {
  ...
  // getRecentProjects directly returns the array
  const projects = Array.isArray(projectsResponse) ? projectsResponse : (projectsResponse as any)?.data || [];

  return (
    <motion.section 
      id="projects" 
      className="py-20 md:py-28 bg-slate-100/70 dark:bg-transparent transition-colors duration-300"
    ...
    >
      <div className="container mx-auto px-6">
        ...
        <div className="mt-16 text-center">
            <Link to="/projects" className="font-semibold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
